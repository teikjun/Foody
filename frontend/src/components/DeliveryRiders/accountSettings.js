...
const DeliveryRiderAccountSettings = (props) => {
  const { uid, commision, changePasswordErrorMsg, changePasswordSuccessMsg, dispatch } = props;
  ...
  return (
    <div>
      <Container style={{ marginTop: "2rem" }}>
        ...
        <h3 style={{ textAlign: "center", paddingBottom: "2rem" }}>Commision: {commision}</h3>
...
const mapStateToProps = (state) => ({
  uid: state.auth.uid,
  commision: state.auth.commision,
...
export default withRouter(connect(mapStateToProps)(DeliveryRiderAccountSettings));
